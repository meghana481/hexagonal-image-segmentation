...
The hexagonally transformed version of the DRIVE dataset used in this study is available here:

https://www.kaggle.com/datasets/nancysakhiya/hexagonal-retinal-vessel-dataset

This dataset was generated by converting the original retinal images into an approximate hexagonal representation while preserving the corresponding ground truth vessel masks. It enables consistent comparison between square and hexagonal image representations for segmentation tasks.
